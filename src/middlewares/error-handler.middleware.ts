...
import { EmailAlreadyExistError, InvalidData, NotFoundError, Unauthorized } from 'exceptions';

/* eslint-disable-next-line no-unused-vars */
export const errorHandler = (err: Error, _req: Request, res: Response, _next: NextFunction) => {
  if (err instanceof InvalidData || err instanceof NotFoundError || err instanceof EmailAlreadyExistError) {
